...
(function (window, $) {
    ...
    angular.module('ngGrid.services').factory('$domUtilityService', ['$utilityService', function ($utils) {
        ...
        var getWidths = function () {
            ...
            //todo:peikai 页面延迟加载时，计算滚动条的宽度失误，设置默认宽度为8
            domUtilityService.ScrollW = domUtilityService.ScrollW === 100 ? 8 : domUtilityService.ScrollW;
        ...
        domUtilityService.digest = function ($scope) {
            //todo suishanwen 销毁modal框作用域后 grid resize问题
